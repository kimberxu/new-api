...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/demoted", permission: authz.ChannelRead, handler: controller.GetDemotedChannels},
	{method: http.MethodGet, path: "/abilities", permission: authz.ChannelRead, handler: controller.GetChannelAbilities},
	{method: http.MethodPost, path: "/abilities/disable", permission: authz.ChannelWrite, handler: controller.DisableChannelAbilities},
	{method: http.MethodPost, path: "/abilities/enable", permission: authz.ChannelWrite, handler: controller.EnableChannelAbilities},
