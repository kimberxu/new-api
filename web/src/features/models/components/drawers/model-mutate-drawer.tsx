...
export function ModelMutateDrawer({
  ...
  const modelSettings = useMemo(() => {
    ...
    const defaultModelSettings: ModelSettings = {
      ...
      'channel_slow_stream_setting.sample_size': 5,
      'channel_slow_stream_setting.threshold': 3,
      ...
      'channel_slow_stream_setting.ttft_sample_size': 5,
      'channel_slow_stream_setting.ttft_threshold': 3,
