...
export const channelFormSchema = z
  .object({
    ...
    capture_real_request_test: z.number().optional(),
    status: z.number(),
...
export function transformChannelToFormDefaults(
  ...
  return {
    ...
    capture_real_request_test: channel.capture_real_request_test ?? 0,
...
export function transformFormDataToCreatePayload(formData: ChannelFormValues): {
  ...
  const channel: Partial<Channel> = {
    ...
    capture_real_request_test: formData.capture_real_request_test ?? 0,
