...
func TestGetRandomSatisfiedChannelSlowStreamDemotion(t *testing.T) {
	...
	*cfg = operation_setting.ChannelSlowStreamSetting{
	...
	ch, _, err = GetRandomSatisfiedChannel("default", "test-model", 0, nil, []ExcludedChannelModel{{ChannelId: 402}})
	require.NoError(t, err)
	require.NotNil(t, ch)
...
func TestGetRandomSatisfiedChannelFromGroupsSlowStreamDemotion(t *testing.T) {
	...
	*cfg = operation_setting.ChannelSlowStreamSetting{
	...
	ch, _, err = GetRandomSatisfiedChannel("default", "test-model", 0, nil, []ExcludedChannelModel{{ChannelId: 412}})
	require.NoError(t, err)
	require.NotNil(t, ch)
